...
var AxiosProvider = /** @class */ (function () {
    ...
    AxiosProvider.prototype.makeHeadersFromObject = function (headersObject) {
        ...
        requestHeaders = Object.entries(headersObject)
            .reduce(function (headersAccumulator, currentPair) {
...
var NavigationThruPages = /** @class */ (function () {
    ...
    NavigationThruPages.prototype.parsePageLinks = function (response, urlSeparator, iteratorName) {
        var _this = this;
        var _a, _b;
        var pages = ((_a = response.body) === null || _a === void 0 ? void 0 : _a.paging) ? Object.entries((_b = response.body) === null || _b === void 0 ? void 0 : _b.paging) : [];
...
var DomainCredentialsClient = /** @class */ (function () {
    ...
    DomainCredentialsClient.prototype.destroyAll = function (domain) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.request.delete("".concat(this.baseRoute).concat(domain, "/credentials"))];
                    case 1:
                        response = _a.sent();
