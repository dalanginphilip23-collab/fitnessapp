import{a as e}from"./rolldown-runtime-CNC7AqOf.js";import{c as t,s as n}from"./motion-vendor-CYHVKki_.js";import{c as r,d as i,o as a}from"./index-Bp6ynFGJ.js";var o=e(t(),1),s=()=>{let[e,t]=(0,o.useState)(!1),[n,r]=(0,o.useState)(``),[s,c]=(0,o.useState)(!1),l=i();return{loading:e,error:n,showSuccessModal:s,handleRegister:async(e,n)=>{e.preventDefault(),t(!0),r(``);try{let e=await fetch(`${a}/api/auth/register`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({name:n.name,email:n.email,password:n.password,fitness_goal:n.goal})}),t=await e.json();if(!e.ok)throw Error(t.error||`Initialization failed. System conflict.`);t.success&&c(!0)}catch(e){r(e.message)}finally{t(!1)}},handleModalConfirm:()=>l(`/login`)}},c=n(),l=`#8FBF63`,u=`#9DCB72`,d=`rgba(143, 191, 99, 0.22)`,f=`rgba(143, 191, 99, 0.05)`,p=[`Peak Metabolic Efficiency`,`Muscle Hypertrophy`,`Fat Loss Protocol`,`Endurance & VO2 Max`,`Athletic Performance`,`Recovery Optimization`],m=()=>{let[e,t]=(0,o.useState)({name:``,email:``,password:``,goal:`Peak Metabolic Efficiency`}),[n,i]=(0,o.useState)(``),{loading:a,error:m,showSuccessModal:h,handleRegister:g,handleModalConfirm:_}=s(),v=[e.name,e.email,e.password].filter(Boolean).length,y=Math.round(v/3*100),b=n=>r=>t({...e,[n]:r.target.value});return(0,c.jsxs)(`div`,{"data-theme":`dark`,className:`relative min-h-screen min-h-[100dvh] w-full bg-[#0e0e0e] font-['DM_Sans'] text-[#e5e2e1] overflow-x-hidden`,children:[(0,c.jsx)(`style`,{children:`
        .vitalis-vignette {
