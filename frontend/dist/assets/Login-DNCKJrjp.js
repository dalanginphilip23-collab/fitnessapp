import{a as e}from"./rolldown-runtime-CNC7AqOf.js";import{c as t,s as n}from"./motion-vendor-CYHVKki_.js";import{a as r,i,o as a,u as o}from"./index-C-sHjzrJ.js";var s=e(t(),1),c=()=>{let[e,t]=(0,s.useState)(``),[n,c]=(0,s.useState)(!1),[l,u]=(0,s.useState)(!1),[d,f]=(0,s.useState)(``),[p,m]=(0,s.useState)({sending:!1,sent:!1,error:``}),h=o(),{setUser:g}=i(),_=e=>({id:e.id||e.user?.id,name:e.name||e.user?.name,email:e.email||e.user?.email,avatar:e.avatar||e.user?.avatar,goal:e.goal||e.user?.goal});return{error:e,loading:n,needsVerification:l,unverifiedEmail:d,resendState:p,handleSubmit:async(e,{email:n,password:i})=>{e.preventDefault(),t(``),u(!1),f(``),m({sending:!1,sent:!1,error:``}),c(!0);try{let e=await fetch(`${r}/api/auth/login`,{method:`POST`,credentials:`include`,headers:{"Content-Type":`application/json`},body:JSON.stringify({email:n,password:i})}),a=await e.json();if(!e.ok)throw a.error===`email_not_verified`&&(u(!0),f(n),t(a.message||`Please verify your email before logging in.`)),Error(a.message||`Login failed`);let o=_(a);if(!o.id)throw Error(`Login response did not include a user ID.`);g(o),h(`/dashboard`)}catch(e){t(e.message)}finally{c(!1)}},handleResendVerification:async()=>{if(d){m({sending:!0,sent:!1,error:``});try{let e=await fetch(`${r}/api/auth/resend-verification`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({email:d})}),n=await e.json();if(!e.ok)throw Error(n.message||`Could not resend verification email.`);m({sending:!1,sent:!0,error:``}),t(``)}catch(e){m({sending:!1,sent:!1,error:e.message})}}},loginWithGoogle:a({onSuccess:async e=>{t(``),c(!0);try{let t=await fetch(`${r}/api/auth/google-login`,{method:`POST`,credentials:`include`,headers:{"Content-Type":`application/json`},body:JSON.stringify({code:e.code})}),n=t.headers.get(`content-type`);if(!n||!n.includes(`application/json`))throw Error(`Server response was not JSON. Check backend console.`);let i=await t.json();if(!t.ok)throw Error(i.message||`Google synchronization failed.`);let a=_(i);if(!a.id)throw Error(`Google login response did not include a user ID.`);g(a),h(`/dashboard`)}catch(e){console.error(`Google Login Error:`,e),t(e.message)}finally{c(!1)}},onError:()=>t(`Google Authentication Interrupted.`),flow:`auth-code`})}},l=n(),u=`#8BC34A`,d=`#9CCC65`,f=`rgba(139, 195, 74, 0.22)`,p=`rgba(139, 195, 74, 0.06)`,m=({className:e=``})=>(0,l.jsxs)(`svg`,{viewBox:`0 0 24 24`,className:e,fill:`none`,stroke:`currentColor`,strokeWidth:`1.8`,strokeLinecap:`round`,strokeLinejoin:`round`,children:[(0,l.jsx)(`path`,{d:`M1.5 12S5 5 12 5s10.5 7 10.5 7-3.5 7-10.5 7S1.5 12 1.5 12Z`}),(0,l.jsx)(`circle`,{cx:`12`,cy:`12`,r:`3`})]}),h=({className:e=``})=>(0,l.jsxs)(`svg`,{viewBox:`0 0 24 24`,className:e,fill:`none`,stroke:`currentColor`,strokeWidth:`1.8`,strokeLinecap:`round`,strokeLinejoin:`round`,children:[(0,l.jsx)(`path`,{d:`M17.94 17.94A10.94 10.94 0 0 1 12 19.5C5 19.5 1.5 12 1.5 12a20.86 20.86 0 0 1 4.22-5.94M9.9 4.24A10.4 10.4 0 0 1 12 4.5c7 0 10.5 7.5 10.5 7.5a20.83 20.83 0 0 1-2.42 3.6M14.12 14.12a3 3 0 1 1-4.24-4.24`}),(0,l.jsx)(`path`,{d:`M1.5 1.5l21 21`})]}),g=()=>{let[e,t]=(0,s.useState)(``),[n,r]=(0,s.useState)(``),[i,a]=(0,s.useState)(``),[g,_]=(0,s.useState)(!1),v=o(),{error:y,loading:b,needsVerification:x,unverifiedEmail:S,resendState:C,handleSubmit:w,handleResendVerification:T,loginWithGoogle:E}=c();return(0,l.jsxs)(`div`,{"data-theme":`dark`,className:`relative min-h-screen min-h-[100dvh] w-full bg-[#0e0e0e] font-['DM_Sans'] text-[#e5e2e1] overflow-x-hidden`,children:[(0,l.jsxs)(`button`,{type:`button`,onClick:()=>v(`/`),className:`fixed top-5 left-5 sm:top-8 sm:left-8 z-50 flex items-center gap-2 px-4 py-2.5 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md text-[11px] font-semibold tracking-widest uppercase text-white/60 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all`,children:[(0,l.jsx)(`span`,{className:`text-base leading-none`,children:`←`}),`Back`]}),(0,l.jsx)(`style`,{children:`
        .vitalis-vignette {
