...
// CARTO's dark and light basemap tile sets. Same provider, same attribution —
// just a different tile path, so the switch is a one-line lookup.
...
const ActivityMap = () => {
  ...
  // Pick the matching CARTO tile set for the current theme. Computed here
  // (not as a module-level constant) so it re-renders whenever the user
  // flips light/dark mode via ThemeToggle.
