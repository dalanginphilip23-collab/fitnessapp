  ...
  <div className="absolute inset-0 z-[500] pointer-events-none">
    ...
    <div className="absolute top-0 left-0 right-0 pointer-events-auto">
      <div className="flex items-start justify-center pt-3 sm:pt-4 px-4">
        <div className="bg-black/70 backdrop-blur-md border border-[var(--border-medium)] rounded-[var(--card-radius-md)] px-4 sm:px-5 py-2 sm:py-2.5 text-center">
      ...
      >
        ...
        <div className="grid grid-cols-2 xs:grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 mb-3 sm:mb-4">
          {[
            ...
            <div key={label} className="bg-white/5 border border-[var(--border-light)] rounded-xl sm:rounded-[var(--card-radius-md)] p-2.5 sm:p-3 text-center">
