export default function CoachFeedbackOverlay({ aiFeedback, isAnalyzing }) {
  return (
    <div className="absolute top-3 left-3 sm:top-6 sm:left-6 z-20 max-w-[calc(100%-5rem)] sm:max-w-[280px]">
      <div className="bg-(--bg-overlay) backdrop-blur-xl p-3 sm:p-5 rounded-[var(--card-radius-md)] sm:rounded-[var(--card-radius-lg)] border border-(--border-medium) border-l-(--accent) border-l-4 sm:border-l-[6px] shadow-(--shadow-xl)">
