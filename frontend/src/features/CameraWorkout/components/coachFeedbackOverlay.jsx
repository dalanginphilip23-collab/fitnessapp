export default function CoachFeedbackOverlay({ aiFeedback, isAnalyzing }) {
  return (
    <div className="absolute top-3 left-3 sm:top-6 sm:left-6 z-20 max-w-[calc(100%-5rem)] sm:max-w-[280px]">
      <div className="bg-[var(--bg-overlay)] backdrop-blur-xl p-3 sm:p-5 rounded-2xl sm:rounded-3xl border border-[var(--border-medium)] border-l-[var(--accent)] border-l-4 sm:border-l-[6px] shadow-[var(--shadow-xl)]">
        ...
        <p className="text-[10px] sm:text-[12px] font-bold text-[var(--text-primary)] italic leading-relaxed">
          {`"${aiFeedback}"`}
        </p>
      </div>
    </div>
