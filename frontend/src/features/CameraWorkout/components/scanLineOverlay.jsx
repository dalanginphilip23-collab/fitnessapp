export default function ScanLineOverlay({ isRecording, cameraOn }) {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-10 border-2 sm:border-4 border-[#D1FD52]/10 rounded-[var(--card-radius-md)] sm:rounded-[2rem] md:rounded-[3rem]">
