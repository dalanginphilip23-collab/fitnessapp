...
const Login = () => {
  ...
  return (
    <div data-theme="dark" className="relative min-h-screen w-full bg-[#0e0e0e] font-['DM_Sans'] text-[#e5e2e1] overflow-hidden flex items-center justify-center">
      ...
      <style>{`
        ...
        .vitalis-grid {
          background-image:
            linear-gradient(rgba(199,242,72,0.03) 1px, transparent 1px),
            linear-gradient(90deg, rgba(199,242,72,0.03) 1px, transparent 1px);
        ...
        .vitalis-scan-bar {
          ...
          height: 2px;
          background: linear-gradient(90deg, transparent, #c7f248, transparent);
          border-radius: 999px;
      ...
      <div className="relative z-10 grid w-full min-h-screen lg:grid-cols-[1fr_480px]">
        ...
        <div className="hidden lg:flex flex-col justify-center p-14 gap-4">
          <span className="v-hero-eyebrow text-[11px] font-semibold tracking-[0.35em] uppercase text-[#c7f248] opacity-80">
        ...
        <div className="flex items-center justify-center p-8">
          <div className="v-card relative w-full max-w-[400px] bg-[#121210]/65 backdrop-blur-[32px] saturate-[140%] border border-[#c7f248]/10 rounded-[20px] p-10 shadow-[0_32px_80px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.06)]">
            ...
            <form onSubmit={(e) => handleSubmit(e, { email, password })} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="v-card-btn group relative w-full bg-[#c7f248] text-[#161f00] font-bold text-[11px] tracking-[0.25em] uppercase p-4 rounded-xl shadow-[0_4px_24px_rgba(199,242,72,0.2)] hover:bg-[#acd52b] hover:-translate-y-0.5 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="v-card-google w-full bg-white/5 border border-white/10 rounded-xl text-[11px] font-semibold tracking-widest uppercase p-3.5 flex items-center justify-center gap-2.5 hover:bg-white/10 transition-colors"
              >
