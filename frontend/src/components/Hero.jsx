...
const Hero = ({ name = 'Athlete', goal = 'Unspecified', avatar, activeProgramCount = 0 }) => {
  ...
  return (
    <div className="bg-[var(--bg-card)] bg-[image:var(--card-gradient)] border border-[var(--border-light)] shadow-[var(--shadow-sm)] rounded-[var(--card-radius-lg)] p-[22px] mb-6 flex items-center justify-between gap-4">
